 ...
 */
public class RestProductFilterResponse {
    private RestProductFilterRequest filterRequest;
    ...
    public void setFilterRequest(RestProductFilterRequest filterRequest) {
    ...
    public RestProductFilterRequest getFilterRequest() {
